...
public class WarpController {
	...
	private final String apiKey = "27cce23a8a75007fc3cbbda22e1e1219d002986f2693403c97fd139bfd01a7a4";
	private final String secretKey = "5d41c140552cec81c5ff70af46a6a92ccc30425dbb147a07fa374bf6f11fe4ec";
	...
	public void onJoinRoomDone(RoomEvent event){
		...
		if(event.getResult()==WarpResponseResultCode.SUCCESS){// success case
			...
			data.put("result", "");
			warpClient.createRoom("shadowfiend", "sf", 2, data);
		}else{
			warpClient.disconnect();
			handleError();
		}
	...
	public void onGetLiveRoomInfo(String[] liveUsers){
		...
		ShadowFiendGame.side = liveUsers.length;
		if(liveUsers!=null){
